...
test('futures without source history remain in history mode and do not fabricate local samples',()=>{
 ...
 assert.equal(plotted.sampled,false);assert.equal(plotted.bars.length,0);
