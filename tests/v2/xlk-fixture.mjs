...
export function nasdaqXlkResponse(raw){
 ...
 const data=url.pathname.endsWith('/chart')?{symbol:'XLK',chart:[{x:Date.parse('2026-09-11T15:59:00Z'),y:187.65,z:{dateTime:'3:59 PM ET'}},{x:Date.parse('2026-09-11T20:00:00Z'),y:187.67,z:{dateTime:'8:00 PM ET'}}]}:{symbol:'XLK',tradesTable:{rows:dailyRows}};
