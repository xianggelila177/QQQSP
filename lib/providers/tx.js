...
export function decodeGbkSmart(s) {
  ...
  // quote: qt.gtimg.cn 实时快照行(市场专属索引: cnQuote不含未验证的52周字段; [30] 墙钟: A股='YYYYMMDDHHMMSS' 紧凑, 美股='YYYY-MM-DD HH:MM:SS')
...
export const TX_FIELDS = {
    ...
    cnQuote: { name: 1, code: 2, price: 3, prevClose: 4, open: 5, volume: 6, time: 30, change: 31, changePct: 32, high: 33, low: 34 },
