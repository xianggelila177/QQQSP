...
export const SOURCES = Object.freeze([
  ...
  {id:'naver',name:'Naver',hosts:['polling.finance.naver.com','api.stock.naver.com','fchart.stock.naver.com','m.stock.naver.com','navercomp.wisereport.co.kr'],markets:['us','kr'],transport:'poll',batch:true,minGapMs:1000,feedCoverage:'网站报价；遵循响应中的检查间隔',feedDelayMinutes:null},
