...
export const SOURCES = Object.freeze([
  ...
  {id:'twse-mis',name:'TWSE MIS',hosts:['mis.twse.com.tw'],markets:['tw'],transport:'poll',batch:false,minGapMs:5000,feedCoverage:'最近成交；精确延迟未验证，遵守 userDelay 轮询提示',feedDelayMinutes:null},
  {id:'twse-stock-day',name:'TWSE STOCK_DAY',hosts:['www.twse.com.tw'],markets:['tw'],transport:'poll',batch:false,minGapMs:1000,feedCoverage:'官方月度日线；成交股数为混合会话统计',feedDelayMinutes:null},
