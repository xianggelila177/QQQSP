...
export const catalogInstruments=()=>instruments;
export function catalogInstrumentFor(symbol){return instruments.find(x=>x.symbol===String(symbol||'').toUpperCase()) || null;}
