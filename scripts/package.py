...
Usage: python3 scripts/package.py /mnt/data/qqqsp-v2.8-source.zip
       python3 scripts/package.py --verify /mnt/data/qqqsp-v2.8-source.zip
...
def package(target):
    ...
    with zipfile.ZipFile(target,'w',compression=zipfile.ZIP_DEFLATED,compresslevel=9) as archive:
        for name,data in sorted(files.items()):
            info=zipfile.ZipInfo(prefix+name,date_time=(2026,9,12,0,0,0));info.create_system=3
